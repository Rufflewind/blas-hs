...
--   > x ⋅ y ≡ ∑[i] x[i] y[i]
--
dotu :: Int -> Ptr (Complex Double) -> Int -> Ptr (Complex Double) -> Int
     -> IO (Complex Double)
...
--   > x* ⋅ y ≡ ∑[i] x[i]* y[i]
--
dotc :: Int -> Ptr (Complex Double) -> Int -> Ptr (Complex Double) -> Int
     -> IO (Complex Double)
...
--   > y ← α x + y
--
axpy :: Int -> Complex Double -> Ptr (Complex Double) -> Int -> Ptr (Complex Double)
     -> Int -> IO ()
axpy = C.zaxpy
...
--   > y ← α T(A) x + β y
--
gemv :: Order -> Transpose -> Int -> Int -> Complex Double -> Ptr (Complex Double)
     -> Int -> Ptr (Complex Double) -> Int -> Complex Double -> Ptr (Complex Double)
     -> Int -> IO ()
gemv = C.zgemv
...
--   > y ← α T(A) x + β y
--
gbmv :: Order -> Transpose -> Int -> Int -> Int -> Int -> Complex Double
     -> Ptr (Complex Double) -> Int -> Ptr (Complex Double) -> Int -> Complex Double
     -> Ptr (Complex Double) -> Int -> IO ()
gbmv = C.zgbmv
...
--   > x ← T(A) x
--
trmv :: Order -> Uplo -> Transpose -> Diag -> Int -> Ptr (Complex Double)
     -> Int -> Ptr (Complex Double) -> Int -> IO ()
trmv = C.ztrmv
...
--   > x ← T(A) x
--
tbmv :: Order -> Uplo -> Transpose -> Diag -> Int -> Int -> Ptr (Complex Double)
     -> Int -> Ptr (Complex Double) -> Int -> IO ()
tbmv = C.ztbmv
...
--   > x ← T(A) x
--
tpmv :: Order -> Uplo -> Transpose -> Diag -> Int -> Ptr (Complex Double)
     -> Ptr (Complex Double) -> Int -> IO ()
tpmv = C.ztpmv
...
--   > x ← T(A⁻¹) x
--
trsv :: Order -> Uplo -> Transpose -> Diag -> Int -> Ptr (Complex Double)
     -> Int -> Ptr (Complex Double) -> Int -> IO ()
trsv = C.ztrsv
...
--   > x ← T(A⁻¹) x
--
tbsv :: Order -> Uplo -> Transpose -> Diag -> Int -> Int -> Ptr (Complex Double)
     -> Int -> Ptr (Complex Double) -> Int -> IO ()
tbsv = C.ztbsv
...
--   > x ← T(A⁻¹) x
--
tpsv :: Order -> Uplo -> Transpose -> Diag -> Int -> Ptr (Complex Double)
     -> Ptr (Complex Double) -> Int -> IO ()
tpsv = C.ztpsv
...
--   > y ← α A x + β y
--
hemv :: Order -> Uplo -> Int -> Complex Double -> Ptr (Complex Double) -> Int
     -> Ptr (Complex Double) -> Int -> Complex Double -> Ptr (Complex Double) -> Int
     -> IO ()
hemv = C.zhemv
...
--   > y ← α A x + β y
--
hbmv :: Order -> Uplo -> Int -> Int -> Complex Double -> Ptr (Complex Double)
     -> Int -> Ptr (Complex Double) -> Int -> Complex Double -> Ptr (Complex Double)
     -> Int -> IO ()
hbmv = C.zhbmv
...
--   > y ← α A x + β y
--
hpmv :: Order -> Uplo -> Int -> Complex Double -> Ptr (Complex Double)
     -> Ptr (Complex Double) -> Int -> Complex Double -> Ptr (Complex Double)
     -> Int -> IO ()
hpmv = C.zhpmv
...
--   > A ← α x y⊤ + A
--
geru :: Order -> Int -> Int -> Complex Double -> Ptr (Complex Double) -> Int
     -> Ptr (Complex Double) -> Int -> Ptr (Complex Double) -> Int -> IO ()
geru = C.zgeru
...
--   > A ← α x y† + A
--
gerc :: Order -> Int -> Int -> Complex Double -> Ptr (Complex Double) -> Int
     -> Ptr (Complex Double) -> Int -> Ptr (Complex Double) -> Int -> IO ()
gerc = C.zgerc
...
--   > A ← α x y† + A
--
her :: Order -> Uplo -> Int -> Double -> Ptr (Complex Double) -> Int
    -> Ptr (Complex Double) -> Int -> IO ()
her = C.zher
...
--   > A ← α x y† + A
--
hpr :: Order -> Uplo -> Int -> Double -> Ptr (Complex Double) -> Int
    -> Ptr (Complex Double) -> IO ()
hpr = C.zhpr
...
--   > A ← α x y† + y (α x)† + A
--
her2 :: Order -> Uplo -> Int -> Complex Double -> Ptr (Complex Double) -> Int
     -> Ptr (Complex Double) -> Int -> Ptr (Complex Double) -> Int -> IO ()
her2 = C.zher2
...
--   > A ← α x y† + y (α x)† + A
--
hpr2 :: Order -> Uplo -> Int -> Complex Double -> Ptr (Complex Double) -> Int
     -> Ptr (Complex Double) -> Int -> Ptr (Complex Double) -> IO ()
hpr2 = C.zhpr2
...
--
syrk :: Order -> Uplo -> Transpose -> Int -> Int -> Complex Double
     -> Ptr (Complex Double) -> Int -> Complex Double -> Ptr (Complex Double)
     -> Int -> IO ()
syrk = C.zsyrk
...
--
syr2k :: Order -> Uplo -> Transpose -> Int -> Int -> Complex Double
      -> Ptr (Complex Double) -> Int -> Ptr (Complex Double) -> Int -> Complex Double
      -> Ptr (Complex Double) -> Int -> IO ()
syr2k = C.zsyr2k
...
--   > C ← α A A† + β C    or    C ← α A† A + β C
--
herk :: Order -> Uplo -> Transpose -> Int -> Int -> Double
     -> Ptr (Complex Double) -> Int -> Double -> Ptr (Complex Double)
     -> Int -> IO ()
herk = C.zherk
...
--   > C ← α A B† + α* B A† + β C    or    C ← α A† B + α* B† A + β C
--
her2k :: Order -> Uplo -> Transpose -> Int -> Int -> Complex Double
      -> Ptr (Complex Double) -> Int -> Ptr (Complex Double) -> Int -> Double
      -> Ptr (Complex Double) -> Int -> IO ()
her2k = C.zher2k
...
trmm :: Order -> Side -> Uplo -> Transpose -> Diag -> Int -> Int
     -> Complex Double -> Ptr (Complex Double) -> Int -> Ptr (Complex Double)
     -> Int -> IO ()
trmm = C.ztrmm
...
--
--   where @A@ is triangular.
trsm :: Order -> Side -> Uplo -> Transpose -> Diag -> Int -> Int -> Complex Double
     -> Ptr (Complex Double) -> Int -> Ptr (Complex Double) -> Int -> IO ()
trsm = C.ztrsm
