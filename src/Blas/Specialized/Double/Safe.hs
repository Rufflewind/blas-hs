...
--   > x ⋅ y ≡ ∑[i] x[i] y[i]
--
dotu :: Int -> Ptr Double -> Int -> Ptr Double -> Int
     -> IO Double
dotu = C.ddot
...
--   > x* ⋅ y ≡ ∑[i] x[i]* y[i]
--
dotc :: Int -> Ptr Double -> Int -> Ptr Double -> Int
     -> IO Double
dotc = C.ddot
...
--   > y ← α x + y
--
axpy :: Int -> Double -> Ptr Double -> Int -> Ptr Double
     -> Int -> IO ()
axpy = C.daxpy
...
--   > y ← α T(A) x + β y
--
gemv :: Order -> Transpose -> Int -> Int -> Double -> Ptr Double
     -> Int -> Ptr Double -> Int -> Double -> Ptr Double
     -> Int -> IO ()
gemv = C.dgemv
...
--   > y ← α T(A) x + β y
--
gbmv :: Order -> Transpose -> Int -> Int -> Int -> Int -> Double
     -> Ptr Double -> Int -> Ptr Double -> Int -> Double
     -> Ptr Double -> Int -> IO ()
gbmv = C.dgbmv
...
--   > x ← T(A) x
--
trmv :: Order -> Uplo -> Transpose -> Diag -> Int -> Ptr Double
     -> Int -> Ptr Double -> Int -> IO ()
trmv = C.dtrmv
...
--   > x ← T(A) x
--
tbmv :: Order -> Uplo -> Transpose -> Diag -> Int -> Int -> Ptr Double
     -> Int -> Ptr Double -> Int -> IO ()
tbmv = C.dtbmv
...
--   > x ← T(A) x
--
tpmv :: Order -> Uplo -> Transpose -> Diag -> Int -> Ptr Double
     -> Ptr Double -> Int -> IO ()
tpmv = C.dtpmv
...
--   > x ← T(A⁻¹) x
--
trsv :: Order -> Uplo -> Transpose -> Diag -> Int -> Ptr Double
     -> Int -> Ptr Double -> Int -> IO ()
trsv = C.dtrsv
...
--   > x ← T(A⁻¹) x
--
tbsv :: Order -> Uplo -> Transpose -> Diag -> Int -> Int -> Ptr Double
     -> Int -> Ptr Double -> Int -> IO ()
tbsv = C.dtbsv
...
--   > x ← T(A⁻¹) x
--
tpsv :: Order -> Uplo -> Transpose -> Diag -> Int -> Ptr Double
     -> Ptr Double -> Int -> IO ()
tpsv = C.dtpsv
...
--   > y ← α A x + β y
--
hemv :: Order -> Uplo -> Int -> Double -> Ptr Double -> Int
     -> Ptr Double -> Int -> Double -> Ptr Double -> Int
     -> IO ()
hemv = C.dsymv
...
--   > y ← α A x + β y
--
hbmv :: Order -> Uplo -> Int -> Int -> Double -> Ptr Double
     -> Int -> Ptr Double -> Int -> Double -> Ptr Double
     -> Int -> IO ()
hbmv = C.dsbmv
...
--   > y ← α A x + β y
--
hpmv :: Order -> Uplo -> Int -> Double -> Ptr Double
     -> Ptr Double -> Int -> Double -> Ptr Double
     -> Int -> IO ()
hpmv = C.dspmv
...
--   > A ← α x y⊤ + A
--
geru :: Order -> Int -> Int -> Double -> Ptr Double -> Int
     -> Ptr Double -> Int -> Ptr Double -> Int -> IO ()
geru = C.dger
...
--   > A ← α x y† + A
--
gerc :: Order -> Int -> Int -> Double -> Ptr Double -> Int
     -> Ptr Double -> Int -> Ptr Double -> Int -> IO ()
gerc = C.dger
...
--   > A ← α x y† + A
--
her :: Order -> Uplo -> Int -> Double -> Ptr Double -> Int
    -> Ptr Double -> Int -> IO ()
her = C.dsyr
...
--   > A ← α x y† + A
--
hpr :: Order -> Uplo -> Int -> Double -> Ptr Double -> Int
    -> Ptr Double -> IO ()
hpr = C.dspr
...
--   > A ← α x y† + y (α x)† + A
--
her2 :: Order -> Uplo -> Int -> Double -> Ptr Double -> Int
     -> Ptr Double -> Int -> Ptr Double -> Int -> IO ()
her2 = C.dsyr2
...
--   > A ← α x y† + y (α x)† + A
--
hpr2 :: Order -> Uplo -> Int -> Double -> Ptr Double -> Int
     -> Ptr Double -> Int -> Ptr Double -> IO ()
hpr2 = C.dspr2
...
--
syrk :: Order -> Uplo -> Transpose -> Int -> Int -> Double
     -> Ptr Double -> Int -> Double -> Ptr Double
     -> Int -> IO ()
syrk = C.dsyrk
...
--
syr2k :: Order -> Uplo -> Transpose -> Int -> Int -> Double
      -> Ptr Double -> Int -> Ptr Double -> Int -> Double
      -> Ptr Double -> Int -> IO ()
syr2k = C.dsyr2k
...
--   > C ← α A B† + α* B A† + β C    or    C ← α A† B + α* B† A + β C
--
her2k :: Order -> Uplo -> Transpose -> Int -> Int -> Double
      -> Ptr Double -> Int -> Ptr Double -> Int -> Double
      -> Ptr Double -> Int -> IO ()
her2k = C.dsyr2k
...
trmm :: Order -> Side -> Uplo -> Transpose -> Diag -> Int -> Int
     -> Double -> Ptr Double -> Int -> Ptr Double
     -> Int -> IO ()
trmm = C.dtrmm
...
--
--   where @A@ is triangular.
trsm :: Order -> Side -> Uplo -> Transpose -> Diag -> Int -> Int -> Double
     -> Ptr Double -> Int -> Ptr Double -> Int -> IO ()
trsm = C.dtrsm
...
rotg :: Ptr Double -> Ptr Double -> Ptr Double
     -> Ptr Double -> IO ()
rotg  = C.drotg

-- | Generate a modified Givens rotation.
--   (Only available for real floating-point types.)
rotmg :: Ptr Double -> Ptr Double -> Ptr Double
      -> Double -> Ptr Double -> IO ()
rotmg = C.drotmg

-- | Apply a Givens rotation.
--   (Only available for real floating-point types.)
rot :: Int -> Ptr Double -> Int -> Ptr Double -> Int
    -> Double -> Double -> IO ()
rot   = C.drot

-- | Apply a modified Givens rotation.
--   (Only available for real floating-point types.)
rotm :: Int -> Ptr Double -> Int -> Ptr Double -> Int
     -> Ptr Double -> IO ()
rotm  = C.drotm
