...
--   > x ⋅ y ≡ ∑[i] x[i] y[i]
--
dotu :: Int -> Ptr Float -> Int -> Ptr Float -> Int
     -> IO Float
dotu = C.sdot
...
--   > x* ⋅ y ≡ ∑[i] x[i]* y[i]
--
dotc :: Int -> Ptr Float -> Int -> Ptr Float -> Int
     -> IO Float
dotc = C.sdot
...
--   > y ← α x + y
--
axpy :: Int -> Float -> Ptr Float -> Int -> Ptr Float
     -> Int -> IO ()
axpy = C.saxpy
...
--   > y ← α T(A) x + β y
--
gemv :: Order -> Transpose -> Int -> Int -> Float -> Ptr Float
     -> Int -> Ptr Float -> Int -> Float -> Ptr Float
     -> Int -> IO ()
gemv = C.sgemv
...
--   > y ← α T(A) x + β y
--
gbmv :: Order -> Transpose -> Int -> Int -> Int -> Int -> Float
     -> Ptr Float -> Int -> Ptr Float -> Int -> Float
     -> Ptr Float -> Int -> IO ()
gbmv = C.sgbmv
...
--   > x ← T(A) x
--
trmv :: Order -> Uplo -> Transpose -> Diag -> Int -> Ptr Float
     -> Int -> Ptr Float -> Int -> IO ()
trmv = C.strmv
...
--   > x ← T(A) x
--
tbmv :: Order -> Uplo -> Transpose -> Diag -> Int -> Int -> Ptr Float
     -> Int -> Ptr Float -> Int -> IO ()
tbmv = C.stbmv
...
--   > x ← T(A) x
--
tpmv :: Order -> Uplo -> Transpose -> Diag -> Int -> Ptr Float
     -> Ptr Float -> Int -> IO ()
tpmv = C.stpmv
...
--   > x ← T(A⁻¹) x
--
trsv :: Order -> Uplo -> Transpose -> Diag -> Int -> Ptr Float
     -> Int -> Ptr Float -> Int -> IO ()
trsv = C.strsv
...
--   > x ← T(A⁻¹) x
--
tbsv :: Order -> Uplo -> Transpose -> Diag -> Int -> Int -> Ptr Float
     -> Int -> Ptr Float -> Int -> IO ()
tbsv = C.stbsv
...
--   > x ← T(A⁻¹) x
--
tpsv :: Order -> Uplo -> Transpose -> Diag -> Int -> Ptr Float
     -> Ptr Float -> Int -> IO ()
tpsv = C.stpsv
...
--   > y ← α A x + β y
--
hemv :: Order -> Uplo -> Int -> Float -> Ptr Float -> Int
     -> Ptr Float -> Int -> Float -> Ptr Float -> Int
     -> IO ()
hemv = C.ssymv
...
--   > y ← α A x + β y
--
hbmv :: Order -> Uplo -> Int -> Int -> Float -> Ptr Float
     -> Int -> Ptr Float -> Int -> Float -> Ptr Float
     -> Int -> IO ()
hbmv = C.ssbmv
...
--   > y ← α A x + β y
--
hpmv :: Order -> Uplo -> Int -> Float -> Ptr Float
     -> Ptr Float -> Int -> Float -> Ptr Float
     -> Int -> IO ()
hpmv = C.sspmv
...
--   > A ← α x y⊤ + A
--
geru :: Order -> Int -> Int -> Float -> Ptr Float -> Int
     -> Ptr Float -> Int -> Ptr Float -> Int -> IO ()
geru = C.sger
...
--   > A ← α x y† + A
--
gerc :: Order -> Int -> Int -> Float -> Ptr Float -> Int
     -> Ptr Float -> Int -> Ptr Float -> Int -> IO ()
gerc = C.sger
...
--   > A ← α x y† + A
--
her :: Order -> Uplo -> Int -> Float -> Ptr Float -> Int
    -> Ptr Float -> Int -> IO ()
her = C.ssyr
...
--   > A ← α x y† + A
--
hpr :: Order -> Uplo -> Int -> Float -> Ptr Float -> Int
    -> Ptr Float -> IO ()
hpr = C.sspr
...
--   > A ← α x y† + y (α x)† + A
--
her2 :: Order -> Uplo -> Int -> Float -> Ptr Float -> Int
     -> Ptr Float -> Int -> Ptr Float -> Int -> IO ()
her2 = C.ssyr2
...
--   > A ← α x y† + y (α x)† + A
--
hpr2 :: Order -> Uplo -> Int -> Float -> Ptr Float -> Int
     -> Ptr Float -> Int -> Ptr Float -> IO ()
hpr2 = C.sspr2
...
--
syrk :: Order -> Uplo -> Transpose -> Int -> Int -> Float
     -> Ptr Float -> Int -> Float -> Ptr Float
     -> Int -> IO ()
syrk = C.ssyrk
...
--
syr2k :: Order -> Uplo -> Transpose -> Int -> Int -> Float
      -> Ptr Float -> Int -> Ptr Float -> Int -> Float
      -> Ptr Float -> Int -> IO ()
syr2k = C.ssyr2k
...
--   > C ← α A B† + α* B A† + β C    or    C ← α A† B + α* B† A + β C
--
her2k :: Order -> Uplo -> Transpose -> Int -> Int -> Float
      -> Ptr Float -> Int -> Ptr Float -> Int -> Float
      -> Ptr Float -> Int -> IO ()
her2k = C.ssyr2k
...
--
--   where @A@ is triangular.
trsm :: Order -> Side -> Uplo -> Transpose -> Diag -> Int -> Int -> Float
     -> Ptr Float -> Int -> Ptr Float -> Int -> IO ()
trsm = C.strsm
...
sdsdot :: Int -> Float -> Ptr Float -> Int -> Ptr Float
       -> Int -> IO Float
sdsdot = C.sdsdot
...
rotg :: Ptr Float -> Ptr Float -> Ptr Float
     -> Ptr Float -> IO ()
rotg  = C.srotg

-- | Generate a modified Givens rotation.
--   (Only available for real floating-point types.)
rotmg :: Ptr Float -> Ptr Float -> Ptr Float
      -> Float -> Ptr Float -> IO ()
rotmg = C.srotmg

-- | Apply a Givens rotation.
--   (Only available for real floating-point types.)
rot :: Int -> Ptr Float -> Int -> Ptr Float -> Int
    -> Float -> Float -> IO ()
rot   = C.srot

-- | Apply a modified Givens rotation.
--   (Only available for real floating-point types.)
rotm :: Int -> Ptr Float -> Int -> Ptr Float -> Int
     -> Ptr Float -> IO ()
rotm  = C.srotm
