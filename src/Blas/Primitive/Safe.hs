...
import Prelude (Double, Float, Int, IO, fromIntegral, ($), (>>), (>>=), return)
...
foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_sdsdot"
  sdsdot'_ :: (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO C2HSImp.CFloat)))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dsdot"
  dsdot'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO C2HSImp.CDouble))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_sdot"
  sdot'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO C2HSImp.CFloat))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ddot"
  ddot'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO C2HSImp.CDouble))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cdotu_sub"
  cdotu_sub'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (IO ())))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zdotu_sub"
  zdotu_sub'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (IO ())))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cdotc_sub"
  cdotc_sub'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (IO ())))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zdotc_sub"
  zdotc_sub'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (IO ())))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_snrm2"
  snrm2'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO C2HSImp.CFloat))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dnrm2"
  dnrm2'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO C2HSImp.CDouble))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_scnrm2"
  scnrm2'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO C2HSImp.CFloat))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dznrm2"
  dznrm2'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO C2HSImp.CDouble))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_sasum"
  sasum'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO C2HSImp.CFloat))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dasum"
  dasum'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO C2HSImp.CDouble))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_scasum"
  scasum'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO C2HSImp.CFloat))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dzasum"
  dzasum'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO C2HSImp.CDouble))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_isamax"
  isamax'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO BlasIndex))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_idamax"
  idamax'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO BlasIndex))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_icamax"
  icamax'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO BlasIndex))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_izamax"
  izamax'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO BlasIndex))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_sswap"
  sswap'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ()))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dswap"
  dswap'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ()))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cswap"
  cswap'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zswap"
  zswap'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_scopy"
  scopy'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ()))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dcopy"
  dcopy'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ()))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ccopy"
  ccopy'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zcopy"
  zcopy'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_saxpy"
  saxpy'_ :: (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_daxpy"
  daxpy'_ :: (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_caxpy"
  caxpy'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zaxpy"
  zaxpy'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_srotg"
  srotg'_ :: ((C2HSImp.Ptr C2HSImp.CFloat) -> ((C2HSImp.Ptr C2HSImp.CFloat) -> ((C2HSImp.Ptr C2HSImp.CFloat) -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (IO ())))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_drotg"
  drotg'_ :: ((C2HSImp.Ptr C2HSImp.CDouble) -> ((C2HSImp.Ptr C2HSImp.CDouble) -> ((C2HSImp.Ptr C2HSImp.CDouble) -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (IO ())))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_srotmg"
  srotmg'_ :: ((C2HSImp.Ptr C2HSImp.CFloat) -> ((C2HSImp.Ptr C2HSImp.CFloat) -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (IO ()))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_drotmg"
  drotmg'_ :: ((C2HSImp.Ptr C2HSImp.CDouble) -> ((C2HSImp.Ptr C2HSImp.CDouble) -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (IO ()))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_srot"
  srot'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (C2HSImp.CFloat -> (C2HSImp.CFloat -> (IO ()))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_drot"
  drot'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (C2HSImp.CDouble -> (C2HSImp.CDouble -> (IO ()))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_srotm"
  srotm'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (IO ())))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_drotm"
  drotm'_ :: (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (IO ())))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_sscal"
  sscal'_ :: (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dscal"
  dscal'_ :: (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cscal"
  cscal'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_csscal"
  csscal'_ :: (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zscal"
  zscal'_ :: (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zdscal"
  zdscal'_ :: (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_sgemv"
  sgemv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dgemv"
  dgemv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cgemv"
  cgemv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zgemv"
  zgemv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_sgbmv"
  sgbmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dgbmv"
  dgbmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cgbmv"
  cgbmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zgbmv"
  zgbmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_strmv"
  strmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ()))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dtrmv"
  dtrmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ()))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ctrmv"
  ctrmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ztrmv"
  ztrmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_stbmv"
  stbmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dtbmv"
  dtbmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ctbmv"
  ctbmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ztbmv"
  ztbmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_stpmv"
  stpmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dtpmv"
  dtpmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ctpmv"
  ctpmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ztpmv"
  ztpmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_strsv"
  strsv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ()))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dtrsv"
  dtrsv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ()))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ctrsv"
  ctrsv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ztrsv"
  ztrsv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_stbsv"
  stbsv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dtbsv"
  dtbsv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ctbsv"
  ctbsv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ztbsv"
  ztbsv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_stpsv"
  stpsv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dtpsv"
  dtpsv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ctpsv"
  ctpsv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ztpsv"
  ztpsv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ssymv"
  ssymv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ()))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dsymv"
  dsymv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ()))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ssbmv"
  ssbmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dsbmv"
  dsbmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_sspmv"
  sspmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dspmv"
  dspmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_sger"
  sger'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dger"
  dger'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ssyr"
  ssyr'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dsyr"
  dsyr'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ssyr2"
  ssyr2'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dsyr2"
  dsyr2'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_sspr"
  sspr'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (IO ()))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dspr"
  dspr'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (IO ()))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_sspr2"
  sspr2'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (IO ()))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dspr2"
  dspr2'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (IO ()))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_chemv"
  chemv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zhemv"
  zhemv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_chbmv"
  chbmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zhbmv"
  zhbmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_chpmv"
  chpmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zhpmv"
  zhpmv'_ :: (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cgeru"
  cgeru'_ :: (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zgeru"
  zgeru'_ :: (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cgerc"
  cgerc'_ :: (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zgerc"
  zgerc'_ :: (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cher"
  cher'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zher"
  zher'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_chpr"
  chpr'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (IO ()))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zhpr"
  zhpr'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (IO ()))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cher2"
  cher2'_ :: (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zher2"
  zher2'_ :: (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_chpr2"
  chpr2'_ :: (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (IO ()))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zhpr2"
  zhpr2'_ :: (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (IO ()))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_sgemm"
  sgemm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dgemm"
  dgemm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cgemm"
  cgemm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zgemm"
  zgemm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ssymm"
  ssymm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ()))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dsymm"
  dsymm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ()))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_csymm"
  csymm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zsymm"
  zsymm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ssyrk"
  ssyrk'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ()))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dsyrk"
  dsyrk'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ()))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_csyrk"
  csyrk'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zsyrk"
  zsyrk'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ssyr2k"
  ssyr2k'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ()))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dsyr2k"
  dsyr2k'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ()))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_csyr2k"
  csyr2k'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zsyr2k"
  zsyr2k'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_chemm"
  chemm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zhemm"
  zhemm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cherk"
  cherk'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr ()) -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zherk"
  zherk'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr ()) -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_cher2k"
  cher2k'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_zher2k"
  zher2k'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ()))))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_strmm"
  strmm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dtrmm"
  dtrmm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ctrmm"
  ctrmm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ztrmm"
  ztrmm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_strsm"
  strsm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CFloat -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CFloat) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_dtrsm"
  dtrsm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (C2HSImp.CDouble -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> ((C2HSImp.Ptr C2HSImp.CDouble) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ctrsm"
  ctrsm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))))

foreign import ccall safe "src/Blas/Primitive/Safe_.chs.h cblas_ztrsm"
  ztrsm'_ :: (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> (BlasInt -> ((C2HSImp.Ptr ()) -> ((C2HSImp.Ptr ()) -> (BlasInt -> ((C2HSImp.Ptr ()) -> (BlasInt -> (IO ())))))))))))))
